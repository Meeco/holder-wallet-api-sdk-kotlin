...
data class DeleteWalletError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: DeleteWalletError.Error,
     ...
     * Unique error identifier
     *
     * Values: deleteWalletError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "delete_wallet_error") deleteWalletError("delete_wallet_error");
    }
}
