...
import me.meeco.holder.wallet.models.InvalidCredentialDataError
...
data class CredentialsControllerImport400Response (

    /* Unique error identifier */
    @Json(name = "error")
    val error: CredentialsControllerImport400Response.Error?,
     ...
     * Unique error identifier
     *
     * Values: invalidCredentialData
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.Any) {
        @Json(name = "invalid_credential_data") invalidCredentialData("invalid_credential_data");
    }
}
