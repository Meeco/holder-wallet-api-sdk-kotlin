...
data class InvalidOrderFilterValueError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: InvalidOrderFilterValueError.Error,
     ...
     * Unique error identifier
     *
     * Values: invalidOrderFilterValue
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "invalid_order_filter_value") invalidOrderFilterValue("invalid_order_filter_value");
    }
}
