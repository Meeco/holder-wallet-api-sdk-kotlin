...
data class LoadCredentialsError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: LoadCredentialsError.Error,
     ...
     * Unique error identifier
     *
     * Values: loadCredentialsError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "load_credentials_error") loadCredentialsError("load_credentials_error");
    }
}
