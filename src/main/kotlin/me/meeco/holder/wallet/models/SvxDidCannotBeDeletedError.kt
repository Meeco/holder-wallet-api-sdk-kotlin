...
data class SvxDidCannotBeDeletedError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: SvxDidCannotBeDeletedError.Error,
     ...
     * Unique error identifier
     *
     * Values: svxAuthenticationDidCannotBeDeleted
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "svx_authentication_did_cannot_be_deleted") svxAuthenticationDidCannotBeDeleted("svx_authentication_did_cannot_be_deleted");
    }
}
