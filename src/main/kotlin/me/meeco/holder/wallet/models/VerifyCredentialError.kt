...
data class VerifyCredentialError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: VerifyCredentialError.Error,
     ...
     * Unique error identifier
     *
     * Values: verifyCredentialError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "verify_credential_error") verifyCredentialError("verify_credential_error");
    }
}
