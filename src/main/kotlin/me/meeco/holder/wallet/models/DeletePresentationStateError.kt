...
data class DeletePresentationStateError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: DeletePresentationStateError.Error,
     ...
     * Unique error identifier
     *
     * Values: deletePresentationStateError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "delete_presentation_state_error") deletePresentationStateError("delete_presentation_state_error");
    }
}
