...
data class PatchCredentialError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: PatchCredentialError.Error,
     ...
     * Unique error identifier
     *
     * Values: patchCredentialError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "patch_credential_error") patchCredentialError("patch_credential_error");
    }
}
