...
data class PresentationStateResponseDto (
    ...
    val responseMode: PresentationStateResponseDto.ResponseMode? = null,

    /* Response type of the request. Possible values are `vp_token`, `id_token` */
    @Json(name = "response_type")
    val responseType: PresentationStateResponseDto.ResponseType? = null,
     ...
     * Response type of the request. Possible values are `vp_token`, `id_token`
     *
     * Values: token,tokenIdToken
     */
    @JsonClass(generateAdapter = false)
    enum class ResponseType(val value: kotlin.String) {
        @Json(name = "vp_token") token("vp_token"),
        @Json(name = "vp_token id_token") tokenIdToken("vp_token id_token");
    }
}
