...
data class InvalidDateFilterValueError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: InvalidDateFilterValueError.Error,
     ...
     * Unique error identifier
     *
     * Values: invalidDateFilterValue
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "invalid_date_filter_value") invalidDateFilterValue("invalid_date_filter_value");
    }
}
