...
import me.meeco.holder.wallet.models.KeySigningNotSupportedError
...
data class KeyControllerSign400Response (

    /* Unique error identifier */
    @Json(name = "error")
    val error: KeyControllerSign400Response.Error?,
     ...
     * Unique error identifier
     *
     * Values: keySigningNotSupported
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.Any) {
        @Json(name = "key_signing_not_supported") keySigningNotSupported("key_signing_not_supported");
    }
}
