...
data class InvalidPathParamError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: InvalidPathParamError.Error,
     ...
     * Unique error identifier
     *
     * Values: invalidPathParam
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "invalid_path_param") invalidPathParam("invalid_path_param");
    }
}
