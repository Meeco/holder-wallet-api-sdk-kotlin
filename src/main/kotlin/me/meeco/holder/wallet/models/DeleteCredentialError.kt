...
data class DeleteCredentialError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: DeleteCredentialError.Error,
     ...
     * Unique error identifier
     *
     * Values: deleteCredentialError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "delete_credential_error") deleteCredentialError("delete_credential_error");
    }
}
