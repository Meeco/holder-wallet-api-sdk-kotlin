...
data class LoadCredentialError (

    /* Unique error identifier */
    @Json(name = "error")
    val error: LoadCredentialError.Error,
     ...
     * Unique error identifier
     *
     * Values: loadCredentialError
     */
    @JsonClass(generateAdapter = false)
    enum class Error(val value: kotlin.String) {
        @Json(name = "load_credential_error") loadCredentialError("load_credential_error");
    }
}
